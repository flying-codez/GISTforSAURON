...
# -*- coding: utf-8 -*-
"""
Created on Wed Oct  5 21:27:36 2022
...
def readCube(config):
    ...
    logging.info("Reading the SAURON cube: "+config['GENERAL']['INPUT'])
    ...
    # Getting the spatial coordinates -- For origin CHECK MASTER CONFIG
    ...
    logging.info("Finished reading the SAURON cube! Read a total of "+str(len(cube['x']))+" spectra!")
